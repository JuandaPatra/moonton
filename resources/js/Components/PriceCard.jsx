export default function PriceCard({ isPremium, dataPackage }) {
    // console.log(dataPackage[0].features);
    let dPfeatures = JSON.parse(dataPackage[0].features);
    // console.log(dPfeatures);
                ...
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content]">
                    ...
                    <div>
                        ...
                        <div className="text-[28px] font-bold">
                            IDR {dataPackage[0].price.toLocaleString()}
                        </div>
                        <p className="text-gray-1 text-xs font-light">
                            /{dataPackage[0].active_period_in_months} months
                        </p>
                    </div>

                    {/* Mid Content: Benefits */}
                    <div className="flex flex-col gap-4">
                        {/* {dataPackage[0].map(item => {
                        ...
                        {/* {
                        dPfeatures.value.map((item,index)=>{
                            <div className="flex items-center gap-2">
                                <img src="/icons/ic_tick.svg" alt="" />
                                <span className="text-sm">
                                    {item}
                        ...
                        <div className="flex items-center gap-2">
                            <img src="/icons/ic_tick.svg" alt="" />
                            <span className="text-sm">{dPfeatures[0]}</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <img src="/icons/ic_tick.svg" alt="" />
                            <span className="text-sm">{dPfeatures[1]}</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <img src="/icons/ic_tick.svg" alt="" />
                            <span className="text-sm">{dPfeatures[2]}</span>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">{dPfeatures[3]}</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg
                                width="24"
                            ...
                            <span className="text-sm">{dPfeatures[4]}</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <svg
                                width="24"
                            ...
                            <span className="text-sm">{dPfeatures[5]}</span>
                        </div>
                    </div>

                    {/* Bottom: CTA Button  */}
                    <div onClick={()=>selectSubcription(dataPackage.name)}>
                        <a
